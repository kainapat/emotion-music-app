...
def get_emotion_explanation(emotion, emotions_list):
    ...
    # สร้างคำอธิบาย
    explanations = {
        'sad': "เพลงนี้มีอารมณ์เศร้าเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความเศร้า ความเสียใจ หรือความหดหู่",
        'lonely': "เพลงนี้มีอารมณ์เหงาเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความโดดเดี่ยว ความว้าเหว่ หรือความรู้สึกเหงา",
        'hope': "เพลงนี้มีอารมณ์หวังเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความหวัง การให้กำลังใจ หรือการมองโลกในแง่ดี",
        'happy': "เพลงนี้มีอารมณ์สุขเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความสุข ความร่าเริง หรือความสนุกสนาน",
        'excited': "เพลงนี้มีอารมณ์ตื่นเต้นเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความตื่นเต้น ความเร้าใจ หรือความเข้มข้น",
        'calm': "เพลงนี้มีอารมณ์สงบเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความสงบ ความเยือกเย็น หรือความผ่อนคลาย",
        'angry': "เพลงนี้มีอารมณ์โกรธเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงความโกรธ ความโมโห หรือความไม่พอใจ",
        'neutral': "เพลงนี้มีอารมณ์เฉยเป็นหลัก เนื่องจากเนื้อเพลงส่วนใหญ่แสดงถึงอารมณ์ที่เป็นกลาง ไม่เด่นชัดไปทางใดทางหนึ่ง"
    }
    
    base_explanation = explanations.get(main_emotion, f"เพลงนี้มีอารมณ์{main_emotion}เป็นหลัก")
