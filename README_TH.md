...
ระบบได้รับการประเมินด้วยชุดทดสอบมาตรฐาน (20 ตัวอย่าง):

| โมเดล             | Accuracy | Precision | Recall | F1-Score |
| ----------------- | -------- | --------- | ------ | -------- |
| **BART (ของเรา)** | 75.0%    | 83.8%     | 75.0%  | 75.7%    |
...
จากการทดสอบบนข้อมูลจริง พบว่าการปรับปรุงนี้ช่วยลด **System Neutral Bias** จาก **63.5%** เหลือประมาณ **~45%** (ลดลง 30% จากกลุ่มตัวอย่าง) โดยรักษาความแม่นยำโมเดลไว้ได้ดีเยี่ยม
